...
function mostrarServicios(servicios){
    servicios.forEach(servicio => {
        ...
        servicioPrecio.classList.add('precio-servicio');
...
function seleccionarServicio(servicio){
    ...
    //comprobar si un servicio ya fue arregalo o quitarlo
...
function mostrarResumen(){
    ...
    const opciones = { weeekday: 'long', year: 'numeric', month: 'long', day: 'numeric'}
